...
const Analytics = () => {
  ...
  return (
    <PageContainer>
      <h1>Dashboard</h1>
      <CustomDatePicker label="De" value={fromDate} onChange={setFromDate} style={{ marginRight: "2rem" }} />
      <CustomDatePicker label="até" value={toDate} onChange={setToDate} style={{ marginRight: "2rem" }} />
      <Button onClick={loadAnalytics} variant="contained" style={{ margin: "0 auto" }} size="large">Atualizar</Button>
